...
<head>
	<meta charset="utf-8" />
	<link rel="icon" type="image/png" href="{{ asset('paper-landing') }}/assets/paper_img/favicon.ico">
    ...
    <link href="{{ asset('paper-landing') }}/bootstrap3/css/bootstrap.css" rel="stylesheet" />
    <link href="{{ asset('paper-landing') }}/assets/css/ct-paper.css" rel="stylesheet"/>
    <link href="{{ asset('paper-landing') }}/assets/css/demo.css" rel="stylesheet" />
    ...
    <div class="navbar-header">
      ...
      <a href="http://www.creative-tim.com">
           <div class="logo-container">
                <div class="logo">
                    <img src="{{ asset('paper-landing') }}/assets/paper_img/new_logo.png" alt="Creative Tim Logo">
                </div>
                <div class="brand">
                    Creative Tim
                </div>
                ...
                <div id="images">
                    ...
                    <div class="row">
                        <div class="col-xs-8 col-sm-6 col-md-3">
                            <h4>Rounded Image</h4>
                            <img src="{{ asset('paper-landing') }}/assets/paper_img/thinking_in_textures.png" alt="Rounded Image" class="img-rounded img-responsive">
                            <div class="img-details">
                                <div class="author">
                                    <img src="{{ asset('paper-landing') }}/assets/paper_img/chet_faker_1.jpg" alt="Circle Image" class="img-circle img-no-padding img-responsive">
                                </div>
                                <p>Chet Faker</p>
                            </div>
                        ...
                        <div class="col-xs-6  col-sm-3 col-md-2 col-md-offset-1">
                            ...
                            <img src="{{ asset('paper-landing') }}/assets/paper_img/placeholder.jpg" alt="Circle Image" class="img-circle img-no-padding img-responsive">
                            <p class="text-center">Placeholder</p>
                        </div>
                        <div class="col-xs-6  col-sm-3 col-md-2 col-md-offset-1">
                            <h4>Thumbnail</h4><br />
                            <img src="{{ asset('paper-landing') }}/assets/paper_img/chet_faker_2.jpg" alt="Thumbnail Image" class="img-thumbnail img-responsive">
        ...
        <div class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner">
                <div class="item active">
                  <img src="{{ asset('paper-landing') }}/assets/paper_img/pencils.jpg" alt="Awesome Image">
                </div>
                <div class="item">
                  <img src="{{ asset('paper-landing') }}/assets/paper_img/shoes.jpg" alt="Awesome Image">
                </div>
                <div class="item">
                  <img src="{{ asset('paper-landing') }}/assets/paper_img/types.jpg" alt="Awesome Image">
                </div>
              </div>
                ...
                <div class="row example-pages">
                    <div class="col-md-4">
                        <a href="examples/landing.html" target="_blank">
                            <img src="{{ asset('paper-landing') }}/assets/paper_img/examples/landing.jpg" alt="Rounded Image" class="img-rounded img-responsive">
                            <h5>Landing Page</h5>
                        </a>
                    </div>
                    <div class="col-md-4">
                        <a href="examples/register.html" target="_blank">
                            <img src="{{ asset('paper-landing') }}/assets/paper_img/examples/register.jpg" alt="Rounded Image" class="img-rounded img-responsive">
                            <h5>Register</h5>
                        </a>
                    </div>
                    <div class="col-md-4">
                        <a href="examples/profile.html" target="_blank">
                            <img src="{{ asset('paper-landing') }}/assets/paper_img/examples/profile.jpg" alt="Rounded Image" class="img-rounded img-responsive">
                            <h5>Profile</h5>
                        </a>
                    </div>
                </div>
...
<!--    end modal -->
    ...
    <script src="{{ asset('paper-landing') }}/assets/js/jquery-1.10.2.js" type="text/javascript"></script>
	<script src="{{ asset('paper-landing') }}/assets/js/jquery-ui-1.10.4.custom.min.js" type="text/javascript"></script>

	<script src="{{ asset('paper-landing') }}/bootstrap3/js/bootstrap.js" type="text/javascript"></script>

	<!--  Plugins -->
	<script src="{{ asset('paper-landing') }}/assets/js/ct-paper-checkbox.js"></script>
	<script src="{{ asset('paper-landing') }}/assets/js/ct-paper-radio.js"></script>
	<script src="{{ asset('paper-landing') }}/assets/js/bootstrap-select.js"></script>
	<script src="{{ asset('paper-landing') }}/assets/js/bootstrap-datepicker.js"></script>

	<script src="{{ asset('paper-landing') }}/assets/js/ct-paper.js"></script>
</html>
